...
public class FirebaseUtil {
    ...
    public static final String DEAL_PICTURES = "deal_pictures";
    ...
    public static ArrayList<TravelDeal> travelDeal;
    ...
    public static void openFbReference(String reference, final Activity callerActivity) {
        ...
        travelDeal = new ArrayList<TravelDeal>();
    ...
    private static void checkAdmin(String userId) {
        ...
        ChildEventListener listener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                Log.d("Admin", "Yor ar an administrator");
            }
